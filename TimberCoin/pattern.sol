...
contract whitelistICO is Crowdsale {
    ...
    function buyTokens() public payable {
        ...
        if (totalAmount > balance) {
            ...
            soldToWhitelist = soldToWhitelist.add(balance);
            return;
        }

        multisig.transfer(msg.value);
        token.transfer(msg.sender, totalAmount);
        soldToWhitelist = soldToWhitelist.add(totalAmount);
    }
...
contract preICO is Crowdsale {
    ...
    function buyTokens() public payable {
        ...
        if (totalAmount > balance) {
            ...
            msg.sender.transfer(cashBack);
            token.transfer(msg.sender, balance);
            soldToPreIco = soldToPreIco.add(balance);
            return;
        }

        multisig.transfer(msg.value);
        token.transfer(msg.sender, totalAmount);
        soldToPreIco = soldToPreIco.add(totalAmount);
    }
...
contract mainICO is Crowdsale {
    ...
    function buyTokens() public payable {
        ...
        if (amount > balance) {
            ...
            msg.sender.transfer(cashBack);
            token.transfer(msg.sender, balance);
            soldToIco = soldToIco.add(balance);
            return;
        }

        multisig.transfer(msg.value);
        token.transfer(msg.sender, amount);
        soldToIco = soldToIco.add(amount);
    }
}
